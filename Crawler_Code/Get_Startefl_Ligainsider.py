...
def replace_player_name(df):
    df = df.replace({'Cleber':'Reis', 'Junior':'Caicara', 'Fedetsky':'Fedetskyi', 'Marset':'Torro'
                                 ...
                                 'Maury':'Borre', 'Tasende':'Angelino', 'Odilon':'Kossounou'})
    return df
...
saison = '2021/22'
spieltag = 23
Url_clubs = 'https://www.ligainsider.de/bundesliga/spieltage/saison-2021-2022/66540/'
...
#df_feature = get_feature_startelf('2021/22', 27)
#df_feature = df_feature['Spieler_ID']
...
#df_away_startelf = df_away_startelf[df_away_startelf['Spieler']!='Keven Schlotterbeck']
