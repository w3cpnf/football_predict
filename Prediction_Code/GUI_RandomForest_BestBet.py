...
variables.set("Gegner_ID Kaderwert_Differenz Kaderwert_Per_Spieler_Differenz Abwehrdifferenz Gesamtdiffferenz \
            ...
            Trainer_ID Gegner_Trainer_ID B365H B365A B365D HeimSystem AuswärtsSystem \
            Home_Shot_Feature Home_Shot_On_Goal_Feature Home_Fouls_Feature Home_Corner_Feature Home_Yellowcard_Feature \
            Home_Redcard_Feature Away_Shot_Feature Away_Shot_On_Goal_Feature Away_Fouls_Feature Away_Corner_Feature \
            Away_Yellowcard_Feature Away_Redcard_Feature L1 L2 L3 L4 L5  GegnerL1 GegnerL2 GegnerL3 GegnerL4 GegnerL5 \
            Startelf")
...
def select_variables():
    ...
    if ("Startelf" in values):
        values.remove('Startelf')
        values.extend(['Spieler_1', 'Spieler_2', 'Spieler_3', 'Spieler_4', 'Spieler_5', 'Spieler_6', 'Spieler_7', 'Spieler_8', 'Spieler_9', 'Spieler_10', 
                      'Spieler_11', 'Gegner_Spieler_1', 'Gegner_Spieler_2', 'Gegner_Spieler_3', 'Gegner_Spieler_4', 'Gegner_Spieler_5',
                      'Gegner_Spieler_6', 'Gegner_Spieler_7', 'Gegner_Spieler_8', 'Gegner_Spieler_9', 'Gegner_Spieler_10', 'Gegner_Spieler_11'])
    print(values)
    ...
    rp.get_randomforest_best_bet(forecast, variables, results, home_team, away_team)
